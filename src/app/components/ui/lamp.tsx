...
export const LampContainer = ({
  ...
  return (
    <div
      className={`relative flex min-h-[400px] flex-col items-center justify-center overflow-hidden bg-black w-full rounded-3xl z-0 ${className || ""}`}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-emerald-500 opacity-30 blur-3xl"></div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-emerald-400 opacity-40 blur-2xl"
        ></motion.div>
