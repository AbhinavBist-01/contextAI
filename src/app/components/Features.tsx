...
export const Features: React.FC = () => {
  ...
  const handleTabClick = (tab: 'pdf' | 'web' | 'youtube') => {
    setActiveTab(tab);
    setIsAutoPlaying(false); // pause auto-play on manual user interaction
  };
    ...
    <section id="features" className="py-28 px-6 md:px-12 relative z-10 border-t border-white/10 bg-black">
      <div className="max-w-7xl mx-auto space-y-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Visual Chart Card 1: Auto-cycling Multi-Format Parser Bar Chart */}
          <motion.div 
            whileHover={{ y: -4 }}
            className="glass-card rounded-3xl p-8 border border-white/10 space-y-6 flex flex-col justify-between"
          >
          ...
          {/* Visual Chart Card 2: HyDE Vector Accuracy Matrix */}
          <motion.div 
            whileHover={{ y: -4 }}
            className="glass-card rounded-3xl p-8 border border-white/10 space-y-6 flex flex-col justify-between"
          >
          ...
          {/* Visual Card 3: Vault Security Topology Diagram */}
          <motion.div 
            whileHover={{ y: -4 }}
            className="glass-card rounded-3xl p-8 border border-white/10 space-y-6 flex flex-col justify-between"
          >
          ...
          {/* Visual Card 4: Grounding Confidence Indicator */}
          <motion.div 
            whileHover={{ y: -4 }}
            className="glass-card rounded-3xl p-8 border border-white/10 space-y-6 flex flex-col justify-between"
          >
